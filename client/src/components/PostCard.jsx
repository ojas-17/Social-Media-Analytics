...
function PostCard({ post }) {
    ...
    return (
        <div className={`w-[23%] flex flex-col rounded-xl border-4 transition-transform duration-200 hover:scale-105 ${theme === 'light' ? 'border-green-400 bg-neutral-300' : 'border-green-600 bg-neutral-900'}`}>
